...
import { BookOpen, CheckCircle, AlertTriangle, Info, Calculator, Euro, Calendar, Users } from 'lucide-react';
          ...
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-4xl font-bold bg-gradient-to-r from-teal-600 to-emerald-700 bg-clip-text text-transparent">
                Guide du Réméré Immobilier
              </h1>
            </div>
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Tout ce que vous devez savoir sur le réméré immobilier : fonctionnement, avantages, inconvénients et conseils pratiques
            </p>
          </div>
          ...
          <div className="space-y-8">
            ...
            <Card className="shadow-lg">
              ...
              <CardContent className="space-y-4">
                <p className="text-slate-600 leading-relaxed">
                  Le réméré immobilier est une opération de vente avec clause de rachat qui permet à un propriétaire 
                  de vendre son bien immobilier tout en conservant la possibilité de le racheter dans un délai déterminé.
                </p>
                <p className="text-slate-600 leading-relaxed">
                  Cette solution est souvent utilisée par des propriétaires qui ont besoin de liquidités rapidement 
                  mais souhaitent conserver l'espoir de récupérer leur bien immobilier à terme.
                </p>
                <div className="bg-teal-50 p-4 rounded-lg border border-teal-200">
                  <h4 className="font-semibold text-teal-800 mb-2">Principe clé</h4>
                  <p className="text-teal-700 text-sm">
                    Le vendeur reçoit immédiatement le prix de vente, mais peut racheter son bien 
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-slate-600">Propriétaire qui vend avec clause de rachat</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="w-6 h-6 bg-teal-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-slate-600">Vente avec clause de rachat</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="w-6 h-6 bg-emerald-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-slate-600">L'acheteur verse le prix de vente</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="w-6 h-6 bg-emerald-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
              ...
              <Card className="shadow-lg">
                ...
                <CardContent className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-medium text-slate-700">Liquidités immédiates</p>
                      <p className="text-sm text-slate-600">Obtenir rapidement des fonds</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-green-500 mt-1 flex-shrink-0" />
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600">Délai de rachat négociable</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="shadow-lg">
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="flex items-start gap-3">
                    <AlertTriangle className="h-4 w-4 text-red-500 mt-1 flex-shrink-0" />
                    <div>
                      <p className="font-medium text-slate-700">Perte définitive</p>
                  ...
                  <div className="flex items-start gap-3">
                    <AlertTriangle className="h-4 w-4 text-red-500 mt-1 flex-shrink-0" />
                    <div>
                      <p className="font-medium text-slate-700">Risque de spéculation</p>
                      <p className="text-sm text-slate-600">L'acheteur peut spéculer sur le bien</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <AlertTriangle className="h-4 w-4 text-red-500 mt-1 flex-shrink-0" />
            ...
            <Card className="shadow-lg bg-gradient-to-r from-teal-50 to-emerald-50 border-teal-200">
              <CardHeader>
                ...
                <CardDescription>
                  Utilisez notre simulateur pour calculer les conditions de votre réméré
                </CardDescription>
              </CardHeader>
              <CardContent>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-amber-700 text-sm leading-relaxed">
                      Le réméré immobilier est une opération complexe qui nécessite une réflexion approfondie. 
