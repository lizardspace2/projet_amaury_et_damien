          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                Financement de l'achat par le vendeur
              </p>
            </div>
              ...
              <Card className="shadow-lg">
                ...
                <CardContent className="space-y-4">
                  <p className="text-slate-600 leading-relaxed">
                    Le crédit-vendeur permet de financer l'achat directement par le vendeur. 
                    C'est une alternative au crédit bancaire traditionnel.
                  </p>
                </CardContent>
              </Card>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-slate-600 mb-2">
                        Calculez les mensualités et le coût total de votre crédit-vendeur.
                      </p>
